...
export const getStaticPaths: GetStaticPaths = async () => {
    const paths = allPosts.filter((post) => post.archived === false).map((post) => post.url)
    return {
        paths,
        fallback: false,
    }
...
export const getStaticProps = async ({ params }: { params: any }) => {
    const post = allPosts.filter((post) => post.archived === false).find((post) => post._raw.flattenedPath === params.slug)
